...
lasso.fit <- glmnet(x, y, alpha = 1, lambda = lambdagrid) # lasso: alpha=1
names(lasso.fit)

# Cross validation
set.seed(123)
cv.result <- cv.glmnet(x, y, alpha=1)
plot(cv.result)
